...
def generate_contour_plot(word, ax, vmin, vmax):
    ...
    ax.scatter(x=made_dis_1, y=made_dis_2, s=5, color='white', label='made', alpha=0.5)
    ...
    ax.set_title(f'60_made_{word}_ml_error_contour')
...
plt.savefig('./figure/60_ml_error_scatter_contour.png',dpi=300)
plt.show()
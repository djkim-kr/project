...
def generate_contour_plot(word, ax, vmin, vmax):
    ...
    ax.scatter(x=org_dis_2, y=org_ang, s=5, color='white', label='original', alpha=0.7)
    ...
    ax.set_title(f'{word}_ml_potential_contour')
...
# plt.savefig('./figure/ml_potential_contour_scatter.png',dpi=300)
plt.show()
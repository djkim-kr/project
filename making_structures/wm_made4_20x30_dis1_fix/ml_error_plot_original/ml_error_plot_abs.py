...
def generate_contour_plot(word, ax, vmin, vmax):
    ...
    for i in range(1,6):
        quip_file_2=f'./data/quip_test_0104/{word}/quip_test_{i}.xyz'
    ...
    ax.set_xlim(0.7,1.4)
    ax.set_ylim(60,150)
    ax.set_title(f'diff_abs_original_{word}_ml_error_contour')
...
plt.savefig('./figure/diff_original_abs_ml_error_1000.png',dpi=300)
# plt.show()
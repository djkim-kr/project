...
def generate_contour_plot(word, ax, vmin, vmax):
    ...
    ax.scatter(x=made_dis_2, y=made_ang, s=5, color='white', label='made', alpha=0.7)
    ...
    ax.set_xlim(0.7,1.4)
    ax.set_ylim(60,150)
    ax.set_title(f'60_made_{word}_ml_pot_contour')
...
plt.savefig('./figure/60_ml_potential_scatter_contour.png',dpi=300)
plt.show()